...
@Slf4j
@Repository
public class MedlemskapRepository implements Handler {
    ...
    @Getter
    private Collection<MedlemskapResource> repository = new ConcurrentLinkedQueue<>();
    ...
    public void init() throws IOException {
        repository.addAll(fakeData.getMedlemskap());
        log.info("Repository contains {} items.", repository.size());
    }

    @Override
    public Set<String> actions() {
        return ImmutableSet.of(ElevActions.GET_ALL_MEDLEMSKAP.name());
    }
