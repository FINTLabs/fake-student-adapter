...
@Slf4j
@Repository
public class BasisgruppeRepository implements Handler {
    ...
    @Getter
    private Collection<BasisgruppeResource> repository = new ConcurrentLinkedQueue<>();
    ...
    public Set<String> actions() {
        return ImmutableSet.of(ElevActions.GET_ALL_BASISGRUPPE.name());
    }
